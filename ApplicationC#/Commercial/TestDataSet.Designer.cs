...
namespace Commercial {
    ...
    public partial class TestDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string name, string email, string adresse) {
...
namespace Commercial.TestDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([name], [email], [adresse]) VALUES (@name, @email, @ad" +
                "resse);\r\nSELECT id, name, email, adresse FROM Users WHERE (id = SCOPE_IDENTITY()" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Users] SET [name] = @name, [email] = @email, [adresse] = @adresse W" +
                "HERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name" +
                "] = @Original_name)));\r\nSELECT id, name, email, adresse FROM Users WHERE (id = @" +
                "id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Commercial.Properties.Settings.Default.TestConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, email, adresse FROM dbo.Users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT id, name, email, adresse FROM dbo.Users";
        ...
        public virtual int Insert(string name, string email, string adresse) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string email, string adresse, int Original_id, string Original_name, int id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string email, string adresse, int Original_id, string Original_name) {
            return this.Update(name, email, adresse, Original_id, Original_name, Original_id);
        }
    }
